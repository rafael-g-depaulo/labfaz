    ...
    <Container>
      <ProfileContentContainer>
        <Aside>
          <AsideHeader>
            <UserPhoto>
              {(data.artist as any).photo_url && (
                <img src={(data.artist as any).photo_url} alt="User avatar" />
              )}
            </UserPhoto>
          ...
          <ButtonContainer>
            {(data.artist as any).curriculum && (
              <a className="downloadCurriculum" href={(data.artist as any).curriculum} download>
        ...
        <Content>
          ...
          <div className="profileInformation">
            ...
            <div>
              ...
              <ul>
                <li>{data.artist.technical.areas?.[0].name?.toUpperCase()}</li>
                <li>
                  EXPERIENCIA :
                  {` ${
                    currentYear -
                    parseInt(data.artist.technical.areas?.[0].started_year ?? "")
                  } `}
                  ANOS
                </li>
                <li>
                  {data.artist.technical.areas?.[0].technical_formation?.toUpperCase()}
                </li>
