      ...
      <FormikStepper
        initialValues={{
          ...
          artist: {
            ...
            gender_specific: data?.artist.gender_specific,
            other_gender: '',
            cpf: data?.artist.cpf,
            ...
            technical: {
              ...
              areas: {
                technical_formation:
                  data?.artist.technical.areas?.[0].technical_formation,
                name: data?.artist.technical.areas?.[0].name,
                describe: data?.artist.technical.areas?.[0].describe,
                started_year: data?.artist.technical.areas?.[0].started_year,
                certificate: data?.artist.technical.areas?.[0].certificate?.map(
            ...
            profilePicture: yup
              ...
              .test(
                ...
                (value) =>
                  (value && !value.name) ||
                  value === null ||
                  (value && value.size <= maxProfilePictureSize)
              ),
            email: yup
              .string()
            ...
            curriculum: yup
              ...
              .test(
                ...
                (value) =>
                  (value && !value.name) ||
                  value === null ||
                  (value && value.size <= maxCurriculumSize)
              ),
            artist: yup.object({
              technical: yup.object({
                areas: yup.object({
      ...
      onSubmit={async (values: any) => {
        if (isLastStep()) {
          ...
          EditProfile(values, values.token)
            ...
            .catch((err: any) => [setError(err.message), setErrorModal(true), setButtonDisabled(false)])
        } else {
