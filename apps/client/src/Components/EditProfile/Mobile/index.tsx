        ...
        initialValues={{
          ...
          artist: {
            ...
            technical: {
              ...
              areas: {
                technical_formation: data?.artist.technical?.areas?.[0].technical_formation,
                ...
                certificate: data?.artist.technical?.areas?.[0].certificate?.map(certificate => certificate.name),
              },
